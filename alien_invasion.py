...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove bullet and aliens after collision detected
    ...
    def _create_fleet(self):
        ...
        # Spacing between each alien is width of one alien
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        """Respond approprietly if any aliens have reached the edge"""
        for alien in self.aliens.sprites():
    ...
    def _change_fleet_direction(self):
        """Change direction of aliens and drop fleet down the screen."""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        ...
        # Draw the start button on the screen if gam einactive
